...
getPlot <- function(localFrame,highlight,alphasize,dotsize,GenreSelection,colorScheme) {
  ...
  p1<-p1+theme(title=element_text(size=15),legend.title=element_blank(),legend.text=element_text(size=15),axis.title= element_text(size=15,face="bold"),axis.text = element_text(colour="black",size=14))
  p1<-p1+labs(fill = "Movie Genres")+theme(legend.position=c(.88,0.03),legend.direction="horizontal")  
